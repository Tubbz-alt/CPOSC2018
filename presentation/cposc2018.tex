...
\end{frame}}
% GOES
{\usebackgroundtemplate{\includegraphics[height=1.0\paperheight,keepaspectratio]{images/goes16-blue.jpg}}
\begin{frame}[plain]
\end{frame}}
{\usebackgroundtemplate{\includegraphics[height=1.0\paperheight,keepaspectratio]{images/goes16-red.jpg}}
\begin{frame}[plain]
\end{frame}}
{\usebackgroundtemplate{\includegraphics[height=1.0\paperheight,keepaspectratio]{images/goes16-green.jpg}}
\begin{frame}[plain]
\end{frame}}
{\usebackgroundtemplate{\includegraphics[height=1.0\paperheight,keepaspectratio]{images/goes16-combined.jpg}}
\begin{frame}[plain]
\end{frame}}
{\usebackgroundtemplate{\includegraphics[height=1.0\paperheight,keepaspectratio]{images/goes16-combined-crop.jpg}}
\begin{frame}[plain]
\end{frame}}
{\usebackgroundtemplate{\includegraphics[height=1.0\paperheight,keepaspectratio]{images/goes-full-res.png}}
\begin{frame}[plain]
    \hfill{\tiny{21696~px}}
\end{frame}}
